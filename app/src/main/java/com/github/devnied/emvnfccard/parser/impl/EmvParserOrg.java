 ...
 *
 */
public class EmvParserOrg extends AbstractParser {

	/**
	 * Class Logger
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(EmvParserOrg.class);
	 ...
	 *            parser template
	 */
	public EmvParserOrg(EmvTemplate pTemplate) {
		super(pTemplate);
	}
