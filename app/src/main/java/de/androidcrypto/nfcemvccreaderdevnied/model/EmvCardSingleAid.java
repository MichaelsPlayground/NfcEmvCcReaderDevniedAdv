...
public class EmvCardSingleAid implements Serializable {
    ...
    // TlvLists generated by TagListParser
    List<TagNameValue> allTlvList;
    List<TagNameValue> selectPpseResponseTlvList;
    List<TagNameValue> selectPidResponseTlvList;
    List<TagNameValue> getProcessingOptionsResponseTlvList;
    List<TagNameValue> getProcessingOptionsVisaResponseTlvList;
    List<TagNameValue> readRecordsTlvList;

    List<TagNameValue> newTlvList; // here we store deep analyzed data in a TagNameValue list
    //List<TagNameValue>
    ...
    public List<TagNameValue> getAllTlvList() {
        return allTlvList;
    }

    public void setAllTlvList(List<TagNameValue> allTlvList) {
        this.allTlvList = allTlvList;
    }

    public List<TagNameValue> getSelectPpseResponseTlvList() {
        return selectPpseResponseTlvList;
    }

    public void setSelectPpseResponseTlvList(List<TagNameValue> selectPpseResponseTlvList) {
        this.selectPpseResponseTlvList = selectPpseResponseTlvList;
    }

    public List<TagNameValue> getSelectPidResponseTlvList() {
        return selectPidResponseTlvList;
    }

    public void setSelectPidResponseTlvList(List<TagNameValue> selectPidResponseTlvList) {
        this.selectPidResponseTlvList = selectPidResponseTlvList;
    }

    public List<TagNameValue> getGetProcessingOptionsResponseTlvList() {
        return getProcessingOptionsResponseTlvList;
    }

    public void setGetProcessingOptionsResponseTlvList(List<TagNameValue> getProcessingOptionsResponseTlvList) {
        this.getProcessingOptionsResponseTlvList = getProcessingOptionsResponseTlvList;
    }

    public List<TagNameValue> getGetProcessingOptionsVisaResponseTlvList() {
        return getProcessingOptionsVisaResponseTlvList;
    }

    public void setGetProcessingOptionsVisaResponseTlvList(List<TagNameValue> getProcessingOptionsVisaResponseTlvList) {
        this.getProcessingOptionsVisaResponseTlvList = getProcessingOptionsVisaResponseTlvList;
    }

    public List<TagNameValue> getReadRecordsTlvList() {
        return readRecordsTlvList;
    }

    public void setReadRecordsTlvList(List<TagNameValue> readRecordsTlvList) {
        this.readRecordsTlvList = readRecordsTlvList;
    }

    public List<TagNameValue> getNewTlvList() {
        return newTlvList;
    }

    public void setNewTlvList(List<TagNameValue> newTlvList) {
        this.newTlvList = newTlvList;
    }
}
