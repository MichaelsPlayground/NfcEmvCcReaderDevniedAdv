...
public class AnalyzeModelFileActivity extends AppCompatActivity {
    ...
    TextInputLayout etAnalyzeApduCommandSelectPpseDecoration;
    TextInputEditText etAnalyzeApduCommandSelectPpse;
    TextInputLayout etAnalyzeApduResponseSelectPpseDecoration;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analyze_model_file);

        Toolbar myToolbar = (Toolbar) findViewById(R.id.main_toolbar);
        setSupportActionBar(myToolbar);
        contextSave = getApplicationContext();
        readResult = findViewById(R.id.tvAnalyzeReadResult);
        addCommandResponseData = findViewById(R.id.swAnalyzeAddCommandResponseDataSwitch);
        showTagDetailData = findViewById(R.id.swAnalyzeShowTagDetailDataSwitch);
        showTagDetailDeepData = findViewById(R.id.swAnalyzeShowTagDetailDeepDataSwitch);

        etAnalyzeApduCommandSelectPpseDecoration = findViewById(R.id.etAnalyzeApduCommandSelectPpseDecoration);
        etAnalyzeApduCommandSelectPpse = findViewById(R.id.etAnalyzeApduCommandSelectPpse);
        etAnalyzeApduResponseSelectPpseDecoration = findViewById(R.id.etAnalyzeApduResponseSelectPpseDecoration);
        etAnalyzeApduResponseSelectPpse = findViewById(R.id.etAnalyzeApduResponseSelectPpse);
        ...
        Button btnImport = findViewById(R.id.btnAnalyzeImportFile);
        ...
        if (isShowTagDetailData) {
            ...
            for (int i = 0; i < aidsSize; i++) {
                ...
                if (isAddCommandResponseData) {
                    ...
                    etAnalyzeApduCommandSelectPpse.setText(BytesUtils.bytesToString(emvCardSingleAid.getApduSelectPpseCommand()));
