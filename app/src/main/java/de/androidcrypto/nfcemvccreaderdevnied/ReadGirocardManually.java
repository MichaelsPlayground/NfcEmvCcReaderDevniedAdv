...
public class ReadGirocardManually extends AppCompatActivity implements NfcAdapter.ReaderCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_read_girocard_manually);
    ...
    public void onTagDiscovered(Tag tag) {
        ...
        try {
            ...
            /**
             * section for Volksbank Girocard
             */

            content += "Read Girocard";
 ...
 */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mImportModelFile.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(ReadGirocardManually.this, ImportModelFileActivity.class);
                startActivity(i);
                return false;
            }
        });
