 ...
 * @author sasc
 *
 * source: https://github.com/sasc999/javaemvreader/blob/master/src/main/java/sasc/emv/CVRule.java
 */
public class CVRule {

    private static final String LOGTAG = "CVRule";
    ...
    public CVRule(byte firstByte, byte secondByte, byte[] amountFieldX, byte[] secondAmountFieldY) {
        ...
        Log.d(LOGTAG, "first byte: " + Util.byte2Hex(firstByte));
        ...
        if(failCVMProcessing()){
            ...
            Log.d(LOGTAG, "for payment sytem");
