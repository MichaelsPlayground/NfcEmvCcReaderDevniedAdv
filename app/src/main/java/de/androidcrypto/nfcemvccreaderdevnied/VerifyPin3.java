...
public class VerifyPin3 extends AppCompatActivity implements NfcAdapter.ReaderCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verify_pin3);
        ...
        readResult = findViewById(R.id.tvVerifyPin3);
...
*/
            ...
            String pin = "2731"; // fixed for MC AAB
...
*/
            ...
            idContentString += "\n" + "\n" + "===========================";
            idContentString += "\n" + "complete commands";
            idContentString += "\n" + "selectPpse: " + BytesUtils.bytesToString(emvCardSingleAid.getApduSelectPpseCommand());
            idContentString += "\n" + "selectPpse parsedResponse:\n" + emvCardSingleAid.getApduSelectPpseParsed();
            idContentString += "\n" + "we select AID for Mastercard: " + BytesUtils.bytesToString(emvCardSingleAid.getSelectedAid());
            idContentString += "\n" + "selectAid: " + BytesUtils.bytesToString(emvCardSingleAid.getApduSelectPidCommand());
            idContentString += "\n" + "selectAid parsedResponse:\n" + emvCardSingleAid.getApduSelectPidParsed();
            idContentString += "\n" + "getProcessingOptions: " + BytesUtils.bytesToString(emvCardSingleAid.getApduGetProcessingOptionsCommand());
            idContentString += "\n" + "getProcessingOptions parsedResponse:\n" + emvCardSingleAid.getApduGetProcessingOptionsParsed();
            byte[] aipData = TlvUtil.getValue(emvCardSingleAid.getApduGetProcessingOptionsResponse(), EmvTags.APPLICATION_INTERCHANGE_PROFILE);
            ...
            idContentString += "\n" + "getLeftPinTryCounter: " + BytesUtils.bytesToString(emvCardSingleAid.getCardLeftPinTryCommand());
            byte[] lptcData = TlvUtil.getValue(emvCardSingleAid.getCardLeftPinTryResponse(), EmvTags.PIN_TRY_COUNTER);
...
*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mImportModelFile.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(VerifyPin3.this, ImportModelFileActivity.class);
                startActivity(i);
                return false;
            }
        });
