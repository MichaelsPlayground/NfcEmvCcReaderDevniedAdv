 ...
 *
 * @author sasc
 * source: https://github.com/sasc999/javaemvreader/blob/master/src/main/java/sasc/emv/ApplicationElementaryFile.java
 */
public class ApplicationElementaryFile implements File {
    ...
    public void dump(PrintWriter pw, int indent){
        ...
        String indentStr = Util.getSpaces(indent+2); // todo check
        if(sfi != null){
            //sfi.dump(pw, indent+Log.INDENT_SIZE);
            sfi.dump(pw, indent+2); // todo check
        }
        ...
        for(Record record : records.values()){
            ...
            record.dump(pw, indent+2); // todo check
        }
    }
